...
conf = {
    ...
    'sasl.password': 'Endpoint=sb://kafkaenabledeventhubns.servicebus.windows.net/;SharedAccessKeyName=sendreceivekafka;SharedAccessKey=4sdfsdfsdfsd355355E=',
...
topic= 'historicalvehiclesensoreventhub'#'VehicleSensorEventHub'
...
for dev in devices:    
    for y in range(0,random.randrange(20)): # For each device, produce 20 events.  
        lfi=0
        if(y%2==0):
        ...
        # Create a dummy vehicle reading.
            ...
            reading = {'id': dev, 'eventtime': str(datetime.datetime.utcnow()+timedelta(days=-200+y)), 'rpm': random.randrange(100), 'speed': random.randint(70, 120), 'kms': random.randint(100, 10000),'lfi': lfi,'lat':latlonglocal[0],'long':latlonglocal[1]}
